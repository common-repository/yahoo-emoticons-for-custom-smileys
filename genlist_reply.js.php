...
?>
var smilies_list4reply = "\
<table border=\"0\" cellspacing=\"0\" cellpadding=\"4\">\
<?php foreach ($clcs_smilies as $k => $v) : ?>
<?php if ($smilies_count % $smilies_col == 0) { ?>
	<tr>\
<?php }?>
		<td><a href=\"javascript:grin('<?php echo $k?>', 'replycontent');smilies_win_hide();void(0);\"><img src=\"<?php echo $imagesdirurl; ?><?php echo $v?>\" border=\"0\" alt=\"smilies\" title=\"smilies\" /></a></td>\
<?php
